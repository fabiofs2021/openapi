...
swagger-cli bundle source/swagger/parts/_credit_cards_apis_part.yml --outfile build/swagger/credit-cards/doc/${VERSION}.json --type=json && cp build/swagger/credit-cards/doc/${VERSION}.json versions/swagger/credit-cards/doc/${VERSION}.json
...
swagger-cli bundle source/swagger/parts/_invoice_financings_apis_part.yml --outfile build/swagger/invoice-financings/doc/${VERSION}.json --type=json && cp build/swagger/invoice-financings/doc/${VERSION}.json versions/swagger/invoice-financings/doc/${VERSION}.json
...
swagger-cli bundle source/swagger/parts/_unarranged_accounts_overdraft_apis_part.yml --outfile build/swagger/unarranged-accounts-overdraft/doc/${VERSION}.json --type=json && cp build/swagger/unarranged-accounts-overdraft/doc/${VERSION}.json versions/swagger/unarranged-accounts-overdraft/doc/${VERSION}.json
...
sed -i '1s/^\(\xef\xbb\xbf\)\?/\xef\xbb\xbf/' build/swagger/credit-cards/doc/*.json
...
sed -i '1s/^\(\xef\xbb\xbf\)\?/\xef\xbb\xbf/' build/swagger/invoice-financings/doc/*.json
...
sed -i '1s/^\(\xef\xbb\xbf\)\?/\xef\xbb\xbf/' build/swagger/unarranged-accounts-overdraft/doc/*.json
